...
class CheckBox extends React.Component {
    ...
    updateField(nlabel, ndescr) {
        this.props.updateRadio({ num: this.props.num, field: { label: nlabel, descr: ndescr }, labels: this.state.labels });
    }
    onAddClick() {
    ...
    updateOptionLabel(label, number) {
        ...
        this.props.updateRadio({ num: this.props.num, field: this.props.field, labels: nlabels });
    }
    render() {
        return (
            <div>
                ...
                <p>
                    {
                        this.state.labels.map(function (option) {
                            return (
                                <p>
                                    <input type="radio" name='option ${this.props.num}' /><Option label={option.label} num={option.num} updateOptionLabel={this.updateOptionLabel}/>
                                </p>
                            );
                        })
                    }
